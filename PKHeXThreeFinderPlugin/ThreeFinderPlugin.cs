            ...
            else
            {
                ...
                for (i=0; i<sav.BoxCount*30; i++)
                {
                    ...
                    if (current_box_mon.Species == (int)Species.Dunsparce)
                    {
                        ...
                        {
                            dunsparce_3_count++;
                            output_message += "Three segmented Dunsparce found in box #" + ((i / 30) + 1).ToString() + " (" + ((SAV9SV)sav).GetBoxName(i / 30) + ") slot " + ((i % 30) + 1).ToString() + "\n";
                        }
                    }
                    else if (current_box_mon.Species == (int)Species.Tandemaus)
                    {
                        ...
                        {
                            tandemaus_3_count++;
                            output_message += "Family of Three Tandemaus found in box #" + ((i / 30) + 1).ToString() + " (" + ((SAV9SV)sav).GetBoxName(i / 30) + ") slot " + ((i % 30) + 1).ToString() + "\n";
                        }
                    }
                }
